...
//  Instagram
//
//  Created by Ray Chang on 2024/3/24.
//

import UIKit

protocol ProfileInfoHeaderCollectionReusableViewDelegate: AnyObject {
    func profileHeaderDidTapPostsButtons(_ header: ProfileInfoHeaderCollectionReusableView)
    func profileHeaderDidTapFollowersButtons(_ header: ProfileInfoHeaderCollectionReusableView)
    func profileHeaderDidTapFollowingButtons(_ header: ProfileInfoHeaderCollectionReusableView)
    func profileHeaderDidTapEditProfileButtons(_ header: ProfileInfoHeaderCollectionReusableView)
}
...
final class ProfileInfoHeaderCollectionReusableView: UICollectionReusableView {
    ...
    @objc private func didTapPostsButton() {
        delegate?.profileHeaderDidTapPostsButtons(self)
    }
    
    @objc private func didTapFollowersButton() {
        delegate?.profileHeaderDidTapFollowersButtons(self)
    }
    
    @objc private func didTapFollowingButton() {
        delegate?.profileHeaderDidTapFollowingButtons(self)
    }
    
    @objc private func didTapEditProfileButton() {
        delegate?.profileHeaderDidTapEditProfileButtons(self)
    }
